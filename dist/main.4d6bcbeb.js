...
},{"./note":"bnZ0V","./clock":"fJoIQ","./main.scss":"kuRHr","./null.css":"gAwCG"}],"bnZ0V":[function(require,module,exports) {
...
function note(opsions = {}) {
    ...
    const renderNotes = ()=>{
        for(let id in obj_reverse(notesStorage))if (notesStorage[id][3]) notelist.insertAdjacentHTML("beforeend", liTemplate(id));
        else setTimeout(()=>{
    ...
    const renderPhotos = (src)=>{
        ...
        if (photoLine.childNodes.length <= 27) photoLine.insertAdjacentHTML("beforeend", `<div style="background-image:url(${src})"><p data-sort="open"><span data-sort="delete">&#128465;</span></p></div>`);
    };
    ...
    const photoHandler = ()=>{
        ...
        if (sort === "open") console.log(event.target);
    };
    const searchHandler = ()=>{
        event.preventDefault();
        ...
        for(let id in notesStorage){
            ...
            if (notesStorage[id][0].match(findWord)) allnotes.querySelector(`[data-id="${id}"]`).style.display = "list-item";
        }
    };
    ...
    const actionWithNote = ()=>{
        ...
        if (type === "favourites") {
            ...
            if (status === "true") notesStorage[id][3] = false;
            if (status === "false") notesStorage[id][3] = true;
            notelist.innerHTML = "";
            renderNotes();
        }
        if (type === "delete") {
...
},{}],"fJoIQ":[function(require,module,exports) {
...
},{}],"kuRHr":[function() {},{}],"gAwCG":[function() {},{}]},["8TtF2","gLLPy"], "gLLPy", "parcelRequire94c2")

//# sourceMappingURL=main.4d6bcbeb.js.map
